...
I remember publishing my first online video, and marveling that people all over the world could see it.  I used a desktop program called RealProducer to encode it at 360 by 240 pixels at a bitrate of 128 Kilobytes per second. We published these videos on a Microsoft IIS server running Active Server Pages, and used Microsoft FrontPage to add and edit the website content.  
